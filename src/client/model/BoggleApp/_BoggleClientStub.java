...
* Friday, April 19, 2024 5:44:48 PM PST
*/
...
public class _BoggleClientStub extends org.omg.CORBA.portable.ObjectImpl implements BoggleClient
{
  ...
  public int attemptJoin (String username, org.omg.CORBA.IntHolder timeRemaining)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                timeRemaining.value = $in.read_long ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return attemptJoin (username, timeRemaining        );
            } finally {
                _releaseReply ($in);
            }
  } // attemptJoin

...
public class _BoggleClientStub extends org.omg.CORBA.portable.ObjectImpl implements BoggleClient
{
  ...
  public void validateAccount (String username, String password) throws wrongCredentials, accountDoesNotExist
  {
            ...
            try {
                ...
                String _id = $ex.getId ();
                if (_id.equals ("IDL:BoggleApp/wrongCredentials:1.0"))
                    throw wrongCredentialsHelper.read ($in);

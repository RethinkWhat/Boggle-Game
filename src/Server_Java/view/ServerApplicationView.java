...
import Server_Java.view.subpages.GameSettingsView;
import Server_Java.view.subpages.PlayersView;
...
public class ServerApplicationView extends JFrame {
    ...
    public ServerApplicationView() {
        ...
        pnlCards.add( serverStatusView, "Server_Java");
    ...
    public void showServerStatusPanel() {
        cardLayout.show(pnlCards, "Server_Java");
    }
    /**

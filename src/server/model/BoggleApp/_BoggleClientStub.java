...
/**
* server.model.client.model.BoggleApp/_BoggleClientStub.java .
...
public class _BoggleClientStub extends org.omg.CORBA.portable.ObjectImpl implements BoggleClient
{
  ...
  public void validateAccount (String username, String password) throws accountLoggedIn, accountDoesNotExist
  {
            ...
            try {
                ...
                String _id = $ex.getId ();
                if (_id.equals ("IDL:server.model.client.model.BoggleApp/accountLoggedIn:1.0"))
                    throw accountLoggedInHelper.read ($in);
                else if (_id.equals ("IDL:server.model.client.model.BoggleApp/accountDoesNotExist:1.0"))
  ...
  public void editInfo (String username, String toEdit, String newInfo) throws updateFailed
  {
            ...
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:server.model.client.model.BoggleApp/updateFailed:1.0"))
  ...
  private void readObject (java.io.ObjectInputStream s) throws java.io.IOException
  {
     ...
     com.sun.corba.se.impl.orbutil.IORCheckImpl.check(str, "server.model.client.model.BoggleApp._BoggleClientStub");
     String[] args = null;

 ...
 implements BoggleClientOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getPFPOFUser", new java.lang.Integer (19));
    _methods.put ("getFullName", new java.lang.Integer (20));
    _methods.put ("isValidWord", new java.lang.Integer (21));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 10:  // BoggleApp/BoggleClient/getOverallWinner
       {
         int gameID = in.read_long ();
         String $result = null;
       ...
       case 13:  // BoggleApp/BoggleClient/editPassword
       {
         try {
           String username = in.read_string ();
       ...
       case 14:  // BoggleApp/BoggleClient/getUserTotalPoints
       {
         String username = in.read_string ();
         int $result = (int)0;
       ...
       case 15:  // BoggleApp/BoggleClient/getUserPointsOngoingGame
       {
         int gameID = in.read_long ();
         String username = in.read_string ();
         int $result = (int)0;
       ...
       case 16:  // BoggleApp/BoggleClient/getNumberOfMatches
       {
         String username = in.read_string ();
         int $result = (int)0;
       ...
       case 17:  // BoggleApp/BoggleClient/getNumberOfWins
       {
         String username = in.read_string ();
         int $result = (int)0;
       ...
       case 19:  // BoggleApp/BoggleClient/getPFPOFUser
       {
         String username = in.read_string ();
         String $result = null;
       ...
       case 20:  // BoggleApp/BoggleClient/getFullName
       {
         String username = in.read_string ();
         String $result = null;
       ...
       case 21:  // BoggleApp/BoggleClient/isValidWord
       {

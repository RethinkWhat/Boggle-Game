 ...
 implements BoggleClientOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // server.model.client.model.BoggleApp/BoggleClient/joinGameRoom
       {
       ...
       case 5:  // server.model.client.model.BoggleApp/BoggleClient/startRound
       {
       ...
       case 8:  // server.model.client.model.BoggleApp/BoggleClient/exitGameRoom
       {
         String username = in.read_string ();
       ...
       case 9:  // server.model.client.model.BoggleApp/BoggleClient/getOverallWinner
       {
         int gameID = in.read_long ();
         String $result = null;
       ...
       case 10:  // server.model.client.model.BoggleApp/BoggleClient/getRoundWinner
       {
         int gameID = in.read_long ();
         String $result = null;
       ...
       case 14:  // server.model.client.model.BoggleApp/BoggleClient/getGamePoints
       {
         String username = in.read_string ();
         int $result = (int)0;
       ...
       case 15:  // server.model.client.model.BoggleApp/BoggleClient/getNumberOfMatches
       {
         String username = in.read_string ();
         int $result = (int)0;
       ...
       case 16:  // server.model.client.model.BoggleApp/BoggleClient/getNumberOfWins
       {
         String username = in.read_string ();
         int $result = (int)0;
       ...
       case 17:  // server.model.client.model.BoggleApp/BoggleClient/getUserRoundPoints
       {
         String username = in.read_string ();
         int $result = (int)0;
         $result = this.getUserRoundPoints (username);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }

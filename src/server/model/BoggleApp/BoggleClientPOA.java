 ...
 implements BoggleClientOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("startRound", new java.lang.Integer (4));
    _methods.put ("getGameDurationVal", new java.lang.Integer (5));
    _methods.put ("getRoundWinner", new java.lang.Integer (6));
    _methods.put ("getOverallWinner", new java.lang.Integer (7));
    _methods.put ("getPoints", new java.lang.Integer (8));
    _methods.put ("getWinnerIfAny", new java.lang.Integer (9));
    _methods.put ("getWordList", new java.lang.Integer (10));
    _methods.put ("getLeaderboard", new java.lang.Integer (11));
    _methods.put ("getUserPoints", new java.lang.Integer (12));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // BoggleApp/BoggleClient/startRound
       {
         String username = in.read_string ();
       ...
       case 5:  // BoggleApp/BoggleClient/getGameDurationVal
       {
         int gameID = in.read_long ();
       ...
       case 6:  // BoggleApp/BoggleClient/getRoundWinner
       {
         String username = in.read_string ();
         int gameID = in.read_long ();
         int roundID = in.read_long ();
       ...
       case 7:  // BoggleApp/BoggleClient/getOverallWinner
       {
         int gameId = in.read_long ();
         String $result = null;
       ...
       case 8:  // BoggleApp/BoggleClient/getPoints
       {
         String username = in.read_string ();
         int $result = (int)0;
       ...
       case 9:  // BoggleApp/BoggleClient/getWinnerIfAny
       {
         int gameID = in.read_long ();
         String $result = null;
       ...
       case 10:  // BoggleApp/BoggleClient/getWordList
       {
         int gameID = in.read_long ();
         int roundID = in.read_long ();
         String $result = null;
       ...
       case 12:  // BoggleApp/BoggleClient/getUserPoints
       {
         String username = in.read_string ();
         int $result = (int)0;

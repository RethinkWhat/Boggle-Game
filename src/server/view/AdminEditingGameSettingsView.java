...
import server.view.subpages.EditingGameSettingsView;
...
public class AdminEditingGameSettingsView extends JFrame{
    ...
    // constructs a frame of AdminEditingGameSettingsView
    public AdminEditingGameSettingsView() {
        super("Word Factory");

        Container contentArea = new JPanel(new BorderLayout());
        contentArea.setBackground(style.deepSkyBlue);

        contentArea.add(new AdminEditingGameSettingsView.HeaderPanel(), BorderLayout.NORTH);

        pnlCards = new JPanel(cardLayout = new CardLayout(0,0));
        contentArea.add(pnlCards, BorderLayout.CENTER);

        pnlCards.add(new EditingGameSettingsView(), "editingSettings");

        cardLayout.show(pnlCards, "editingSettings");
    ...
    public static void main(String[] args) {
        new AdminEditingGameSettingsView();
    }
}